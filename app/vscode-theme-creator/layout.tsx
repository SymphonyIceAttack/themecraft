...
export const metadata: Metadata = {
  ...
  description:
    "Create stunning VS Code themes with our visual editor. Generate custom color schemes, syntax highlighting, and export directly to VS Code. Free online theme creator.",
  keywords: [
